  ...
  return (
    <section className="custom-height relative">
      <div className="container z-50 mx-auto my-auto flex h-full flex-col justify-center px-5 text-white md:px-10 xl:px-28 3xl:px-5">
        ...
        <p className="mt-8 max-w-[600px] text-xl 3xl:text-2xl">Why wait? Our 10-minute delivery service brings your favorite chocolates right to your door, swiftly and reliably. Convenience and indulgence, all in one package.</p>
